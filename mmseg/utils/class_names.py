...
def rs_classes():
    return [
        'Invalid Annotation', 'Water', 'Transportation', 'Building',
...
def rs_palette():
    return [
        ...
        [255, 255, 0], [255, 192, 203], [255, 165, 0], [128, 0, 128], [0, 255, 255],
    ]
...
dataset_aliases = {
    ...
    'rs': ['Invalid Annotation', 'Water', 'Transportation', 'Building',
           'Farmland', 'Grassland', 'Forest', 'Soil', 'Other'],
    'isaid': ['isaid', 'iSAID'],
    'stare': ['stare', 'STARE'],
    'lip': ['LIP', 'lip'],
